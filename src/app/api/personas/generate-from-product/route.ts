...
Antworte als JSON-Array. Jedes Segment:
{
  ...
  "education": NUR aus: ["hauptschule", "realschule", "abitur", "ausbildung", "meister", "studium", "promotion"],
  "income_min": monatliches Netto in EUR,
  "income_max": monatliches Netto in EUR,
  "core_values": NUR aus: ["freiheit", "sicherheit", "wachstum", "authentizitaet", "nachhaltigkeit", "effizienz", "qualitaet", "preis_leistung", "community", "innovation", "bequemlichkeit", "zuverlaessigkeit", "roi", "selbstverwirklichung"],
  "pain_points": ["Problem1", "Problem2", "Problem3"] (Freitext),
  "goals": ["Ziel1", "Ziel2"] (Freitext),
  "buying_style": NUR aus: "impulsive" oder "impulsive_mixed" oder "considered" oder "rational",
  "platforms": NUR aus: ["instagram", "tiktok", "linkedin", "facebook", "youtube", "google", "email", "podcast"],
  "media_consumption": NUR aus: ["social_media", "podcasts", "youtube", "newsletter", "fachmedien", "blogs", "tiktok", "youtube_shorts", "instagram_reels"],
  "tech_affinity": 0-100,
